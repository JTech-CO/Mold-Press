...
for name in ['check_syntax.py','enhancements.py','kernel_contract.py','browser_workflow.py','storage_tests.py','press_selection_edges.py','release_smoke.py','static_site.py']:
